...
import controller.OpenSACLoginController
...
class JanelaEscolhaInstancias(QWidget):
    ...
    def confirmar(self):
        ...
        if not self.radio_private.isChecked() and not self.radio_prime.isChecked():
            ...
            abrir_instancias(self.checkboxes_marcadas, self.spinner_instancias.value())
...
class JanelaLogin(QWidget):
    ...
    def verificar_login(self):
        ...
        if not usuario or not senha:
            ...
            if controller.OpenSACLoginController.validar_login(usuario, senha):
                self.abrir_janela_principal()
            elif not controller.OpenSACLoginController.validar_login(usuario, senha):
                QMessageBox.critical(self, "Erro", "Usuário ou Senha estão incorretos!")

    def abrir_janela_principal(self):
        self.janela_principal = JanelaEscolhaInstancias()  # Cria a nova janela
        self.janela_principal.show()  # Exibe a nova janela
